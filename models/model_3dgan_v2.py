...
def generator(trainable=True, params={'noise_size': 200, 'strides': (2, 2, 2), 'kernel_size': (4, 4, 4)}):
    ...
    generator_l1 = BatchNormalization(momentum=momentum)(generator_l1, training=trainable)
    ...
    generator_l2 = BatchNormalization(momentum=momentum)(generator_l2, training=trainable)
    ...
    generator_l3 = BatchNormalization(momentum=momentum)(generator_l3, training=trainable)
    ...
    generator_l4 = BatchNormalization(momentum=momentum)(generator_l4, training=trainable)
    ...
    generator_l5 = BatchNormalization(momentum=momentum)(generator_l5, training=trainable)
...
def discriminator(params={'input_dim': 64, 'strides': (2, 2, 2), 'kernel_size': (4, 4, 4), 'leak_value': 0.2}):
    """
    ...
    discriminator_l1 = Dropout(dropout)(discriminator_l1)
    ...
    discriminator_l2 = Dropout(dropout)(discriminator_l2)
    ...
    discriminator_l3 = Dropout(dropout)(discriminator_l3)
    ...
    discriminator_l4 = Dropout(dropout)(discriminator_l4)
